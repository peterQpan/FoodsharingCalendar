...
class LoggingWindow:
    ...
    def __init__(self, input_queue=randomone.DevQueue()):
        ...
        self.tk.iconbitmap("FoodCalendar.ico")
        self.tk.wm_title("Foodsharing Calendar v0.1.3")
...
class LEntry(tkinter.Frame):
    ...
    def okCallBack(self):
        try:
            ...
            tkinter.messagebox.showerror(title="Fehler", message="Irgendetwas ist schief gegangen...\nversuche es nochmal")
...
class Startframe(tkinter.Frame):
    def __init__(self, master=None, first=True, one_two:list=False):
        ...
        self.first = first
        self.master.wm_title("Foodsharing Calendar v0.1.3")
        self.text = self.text()
        if not master:
